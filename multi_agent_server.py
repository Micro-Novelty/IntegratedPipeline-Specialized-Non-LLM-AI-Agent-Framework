...
class ServerAgent:
    ...
    def initialize_pipeline(self):
        ...
        try:
            ...
            self.pipeline = IntegratedPipeline(memory_name=self.memory_name, use_async=True, agent_port=5556, ssl_cert_file=None, ssl_key_file=None ) # for asynchronous prediction set use_async=True
