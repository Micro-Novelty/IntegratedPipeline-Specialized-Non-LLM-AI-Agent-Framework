                    ...
                    if need_ensemble_method:
                        ...
                        if mlp_confidence > trans_confidence and mlp_confidence > lstm_confidence and not mlp_confidence > 0.95:
                            ...
                            if final_confidence > 0.95:
                                ...
                                print(f"[🔄] MLP chosen for sample {i} due to LSTM miscalibrated output, MLP confidence: {mlp_confidence:.1%}") 
                            else:                               
                                print(f"[🔄] LSTM chosen for sample {i} due to highest confidence: {final_confidence:.1%}")
