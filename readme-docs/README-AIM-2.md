...
- Library installation: 
  ```bash
  pip install AbstractIntegratedModule-hybrid
  python -m install AbstractIntegratedModule-hybrid
  ```

- The library also includes wheels for:
  - x86_64 manylinux (accepts version 2.17+) architecture, accepts python version 3.10 only.
  - x86_64 musllinux (accepts version 1.2+) architecture, accepts python version 3.10 only.
  - aarch64 manylinux (accepts version 2.17+) architecture, accepts python 3.12 only.
  - aarch64 musllinux (accepts version 1.2+) architecture, accepts python 3.12 only.
...
- ```bash
  pip install AbstractIntegratedModule-hybrid # or
  python -m pip install AbstractIntegratedModule-hybrid
  ```
