...
- Library installation: 
  ```bash
  pip install AbstractIntegratedModule-macOS
  python -m install AbstractIntegratedModule-macOS
  ```

- The library also includes wheels for:
  - macOS ARM64 architecture (minimum version 11.0 only, accepts version 11.0+) architecture, accepts python 3.10, 3.11, 3.12
  - macOS x86_64 (accept version 10.9+ and 10.13+) architecture, accepts python 3.10, 3.11, 3.12
...
- ```bash
  pip install AbstractIntegratedModule-macOS # or
  python -m pip install AbstractIntegratedModule-macoS
  ```
