# === COMPLETE WORKING EXAMPLE FOR DOCKER CONTAINER ===
# ALONG WITH ASYNCHRONOUS PREDICTION
...
main_model = IntegratedPipeline(memory_name=memory_name, use_async=True, agent_port=5555, ssl_cert_file=None, ssl_key_file=None) # provide cert_file path or key_file path (optional)
...
predicted_output = async_manager.advanced_batch_prediction(test_titles, label_map, example_rules, secret_key, client_ip=None)
