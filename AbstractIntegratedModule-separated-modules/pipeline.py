...
# ---------------------------------------------------------------------------
# pipeline.py
# IntegratedPipeline: the top-level orchestrator that wires together MLP,
# Transformer, WeightedEnsemblePredictor, ModelStorage, CrossSessionAutomation,
# QueryNode, AutoBatcherAutomation, and AgentDistributedInference into a single
# trainable, persistable, and query-able pipeline.
# Depends on: geometry, nn, mlp, transformer, ensemble, storage, inference
# ---------------------------------------------------------------------------
from .geometry import GeometricWeightShaping
from .nn import Dense, Loss, Activation
from .mlp import MLP
