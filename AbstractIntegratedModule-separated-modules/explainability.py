...
# ---------------------------------------------------------------------------
# explainability.py
# ExplainabilityModule: feature attribution, attention heat-maps,
# continual learning feedback loop, and geometry-aware correction LR.
# Depends on: geometry, nn (Loss), mlp (MLP), transformer (Transformer)
# ---------------------------------------------------------------------------
